                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <select name="role" id="role"
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-blue-500 focus:border-blue-500 shadow-sm appearance-none">
