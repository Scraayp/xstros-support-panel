                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                    <span class="@if($user->role === 'Admin') bg-blue-400 text-white @elseif($user->role === 'Staff') bg-green-200 text-green-800 @else bg-gray-200 text-gray-800 @endif px-2 py-1 rounded">
                                        {{$user->role}}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center flex justify-center items-center">
                                    <a href="{{route('user.edit', $user->id)}}">
                                        <button class="px-2 py-1 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-700 mx-1">
                                            Edit
                                        </button>
                                    </a>
                                    <!-- Trigger Modal -->
                                    <button data-modal-target="popup-modal-{{ $user->id }}" data-modal-toggle="popup-modal-{{ $user->id }}" class="px-2 py-1 bg-red-600 text-white text-sm font-medium rounded hover:bg-red-700 mx-1">
                                        Delete
                                    </button>
