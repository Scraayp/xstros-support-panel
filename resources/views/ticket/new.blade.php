<x-app-layout>
    ...
    <form class="max-w-sm mx-auto" method="POST" action="{{ route('ticket.create') }}">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="large-input" name="message" class="block w-full p-15 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        </div>
