    ...
    >
        ...
        <div class="flex items-center justify-between border-b border-gray-200 p-6 dark:border-gray-700">
            <div class="flex items-center space-x-4">
                <div class="flex-shrink-0 rounded-full bg-gray-100 p-2 dark:bg-gray-700">
                    <svg
        ...
        <div class="flex items-center justify-between p-6">
            <div class="flex items-center space-x-4">
                <div class="flex-shrink-0 rounded-full bg-[#5865F2]/10 p-2 dark:bg-[#5865F2]/20">
                    <svg
                        class="h-8 w-8 text-[#5865F2]"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center">
                        ...
                        @else
                            <a
                                href="{{ url('auth/discord/redirect') }}"
                                class="inline-flex items-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700"
                            >
                                Connect
                            </a>
