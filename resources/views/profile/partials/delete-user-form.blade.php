<section class="space-y-6">
    ...
    <x-danger-button
        ...
        class="group relative overflow-hidden rounded-md bg-gradient-to-r from-red-600 to-red-500 px-4 py-2.5 transition-all duration-200 hover:from-red-500 hover:to-red-600"
    >
        <span
            class="absolute inset-0 bg-red-600 opacity-0 transition-opacity duration-200 group-hover:opacity-20"
        ></span>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <div class="p-6">
            ...
            <div class="mb-6 text-center">
                <div
                    class="mb-4 inline-flex items-center justify-center rounded-full bg-red-100 px-4 py-2 text-sm font-medium text-red-600 dark:bg-red-900/30 dark:text-red-400"
                >
                    <svg
                        class="mr-2 h-4 w-4"
                        fill="currentColor"
            ...
            <form method="post" action="{{ route('profile.destroy') }}">
                ...
                <div class="mb-6">
                    <div class="mb-3 text-center text-sm font-medium text-gray-700 dark:text-gray-300">
                        Your email:
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <x-text-input
                            ...
                            type="email"
                            class="block w-full rounded-md border-gray-300 pl-10 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white"
