<section class="space-y-6">
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <div class="password-container">
                    <x-text-input 
                        ...
                        type="password" 
                        class="block w-full rounded-md border-gray-300 dark:border-gray-700 pl-10 pr-10 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:text-white sm:text-sm" 
                        autocomplete="current-password"
                        placeholder="••••••••" 
                    />
                    <button type="button" class="toggle-password absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 focus:outline-none">
        ...
        <div class="space-y-2">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <div class="password-container">
                    <x-text-input 
                        ...
                        name="password" 
                        type="password" 
                        class="block w-full rounded-md border-gray-300 dark:border-gray-700 pl-10 pr-10 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:text-white sm:text-sm password-strength" 
            ...
            <div class="mt-1">
                <div class="password-strength-meter flex h-1 w-full space-x-1 rounded-full overflow-hidden">
                    <div class="strength-segment bg-gray-200 dark:bg-gray-700 flex-1 rounded-full"></div>
                    <div class="strength-segment bg-gray-200 dark:bg-gray-700 flex-1 rounded-full"></div>
                    <div class="strength-segment bg-gray-200 dark:bg-gray-700 flex-1 rounded-full"></div>
                    <div class="strength-segment bg-gray-200 dark:bg-gray-700 flex-1 rounded-full"></div>
                </div>
                <p class="password-strength-text mt-1 text-xs text-gray-500 dark:text-gray-400">Password strength: <span>Too weak</span></p>
            </div>
            <x-input-error :messages="$errors->updatePassword->get('password')" class="mt-1" />
            <p class="text-xs text-gray-500 dark:text-gray-400">Must be at least 8 characters and include a number and a symbol</p>
        </div>
